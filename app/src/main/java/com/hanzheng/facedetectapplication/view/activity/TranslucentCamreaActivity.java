...
public class TranslucentCamreaActivity extends AppCompatActivity implements Camera.PreviewCallback,
        GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    static final String TAG = TranslucentCamreaActivity.class.getSimpleName();
    static final int ACTION_OPEN_CAMREA = 100;
    ...
    private boolean faceDetectRunning = false;
    ...
    private Consumer<Long> mConsumer = new Consumer<Long>() {
        ...
        public void accept(Long aLong) throws Exception {
            try {
                ...
                //获取计数大于n次的数据
                List<FaceLink> list = FaceDetectManager.getInstance().getFaceLinkOverCount
                        (AppConfig.getShootCount());
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                ...
                if (action.equals(Constant.ACTION_START_FACE_DETECT)) {
                    ...
                    Toast.makeText(TranslucentCamreaActivity.this, "人脸检测开始...", Toast
                            .LENGTH_SHORT).show();
                } else if (action.equals(Constant.ACTION_STOP_FACE_DETECT)) {
                    faceDetectRunning = false;
                    Toast.makeText(TranslucentCamreaActivity.this, "人脸检测停止...", Toast
                            .LENGTH_SHORT).show();
                    TranslucentCamreaActivity.this.finish();
                } else if (action.equals(Constant.ACTION_CATCH_FACE)) {
                    catchFaceRunning = true;
                    catchFaceStartTime = System.currentTimeMillis();
                    Toast.makeText(TranslucentCamreaActivity.this, "开始抓拍人脸", Toast.LENGTH_SHORT)
                            .show();
                }
            } catch (Exception ex) {
                HmctLog.e(TAG, ex.toString());
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        createToucher();
        HmctLog.i(TAG, "******TranslucentCamrea is Open*******");
        initFromIntent();
        initViews();
        try {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        HmctLog.d(TAG, "onNewIntent,action=" + intent.getAction());
        String action = getIntent().getAction();
        if(action.equals(Constant.ACTION_CATCH_FACE)){
            catchFaceRunning = true;
            catchFaceStartTime = System.currentTimeMillis();
        }else if(action.equals(Constant.ACTION_START_FACE_DETECT)){
            faceDetectRunning = true;
        }else if(action.equals(Constant.ACTION_STOP_FACE_DETECT)){
            faceDetectRunning = false;
        }
    ...
    protected void onDestroy() {
        ...
        HmctLog.d(TAG, "******Translucent Camrea exit*******");
        try {
...
//        }
        ...
        //WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE; 不可点
        //FLAG_NOT_TOUCH_MODAL
        //WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM;
//        params.flags = WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL
//                | WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE;
        params.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams
                .FLAG_NOT_TOUCH_MODAL |
        ...
        //获取浮动窗口视图所在布局.
        toucherLayout = (RelativeLayout) inflater.inflate(R.layout.activity_translucent_camrea,
                null);
        //添加toucherlayout
        ...
        //主动计算出当前View的宽高信息.
        //toucherLayout.measure(View.MeasureSpec.EXACTLY,View.MeasureSpec.EXACTLY);
    }
    ...
    protected void initViews() {
        ...
        Screen.initialize(TranslucentCamreaActivity.this);
        //setContentView(R.layout.activity_translucent_camrea);
        mSurfaceView = (GLSurfaceView) toucherLayout.findViewById(R.id.camrea_surfaceview);
...
//            mSurfaceView.setLayoutParams(layout_params);
            ...
            mHandler.sendEmptyMessageDelayed(ACTION_OPEN_CAMREA, 1000);
...
//                            BitmapUtils.save(bitmap, filepath);
                            ...
                            try {
                                ...
                                if (floats != null) {
                                    features.add(floats);
                                    HmctLog.i(TAG, "Seq1 faceFeatureExtract success,ret=" +
                                            StringUtils
                                                    .convert(floats));
                                }
                            } catch (Exception ex) {
